...
class DatabasePessoa(object):
    ...
    def atualiza(self, colunas, valores, where_colunas, where_valores):
    ...
    def obtem(self, colunas='*', where_colunas='', where_valores='', one=False):
        query_sql = "SELECT "+colunas+" FROM " + self.tabela + " "
    ...
    def deleta(self, where_colunas, where_valores):
